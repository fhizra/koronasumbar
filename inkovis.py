...
def plot_confirmed_case(
    ...
    ax.plot(
        ...
        color='#cbbeb5', linestyle='--',
        marker='o', markerfacecolor='#66CCCC')

    # BAR
    # POSITIVE
    ax.bar(
        x_pos, total_positive, bottom=total_deaths+total_recovered,
        color='#66CCCC', label='Dalam Perawatan (Positif COVID-19)'
    )
    ...
    if show_diff_bar:
        ...
        ax.bar(
            ...
            color='#66CCCC', edgecolor='black', alpha=0.5
        )
    ...
    if show_title:
        text_title = (
            'KASUS KONFIRMASI COVID-19 DI SUMATERA BARAT'
...
def plot_testing_case(
    ...
    ax.bar(
        ...
        color='#cbbeb5', label='NEGATIF COVID-19', alpha=0.7
    )
    ...
    if show_diff_bar:
        ...
        ax.bar(
            ...
            color='#cbbeb5', edgecolor='black', alpha=0.5
        )
    ...
    if show_numbers:
        for i, val in enumerate(total_tests):
            ...
            ax.annotate(
                ...
                bbox=dict(
                    facecolor='#cbbeb5', alpha=0.7, boxstyle='round'
                )
            )
            ...
            if i > 0 and show_diff_numbers:
                ...
                ax.annotate(
                    ...
                    ha='center', va='bottom', size=10,
                    bbox=dict(
                        facecolor='#cbbeb5', alpha=0.3, boxstyle='round'
                    )
                )
    ...
    if show_title:
        text_title = (
            'JUMLAH SPESIMEN COVID-19 DI SUMATERA BARAT'
            if text_title is None else text_title
        )
        ax.set_title(
            text_title,
...
def plot_confirmed_growth(
    ...
    if show_numbers:
        for i, val in enumerate(diff_confirmed):
            ...
            ax.annotate(
                ...
                bbox=dict(
                    facecolor='#66CCCC', alpha=1, boxstyle='square'
                )
            )
    ...
    if show_title:
        text_title = (
            'PERKEMBANGAN KASUS KONFIRMASI COVID-19 DI SUMATERA BARAT'
            if text_title is None else text_title
        )
        ax.set_title(
            text_title,
...
def plot_testing_growth(
    ...
    if show_bar:
        ...
        ax.bar(
            ...
            color='#cbbeb5',  alpha=0.5,  # edgecolor='black', alpha=0.7,
    ...
    if show_numbers:
        for i, val in enumerate(diff_tests):
            ...
            ax.annotate(
                ...
                color='white', family='monospace',
                bbox=dict(
                    facecolor='#cbbeb5', alpha=1, boxstyle='square'
                )
            )
...
def plot_confirmed_percent(
    ...
    ax.barh(
        ...
        color='#66CCCC', label='Dalam Perawatan'
    )
